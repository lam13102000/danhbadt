...
<body>
  ...
  <div class="topnav">
   ...
   <form action="addct.php" method="POST" enctype="multipart/form-data">
    <table border="0" width="40%">
      <tr>
        <td>Tên công ty</td>
        <td><input type="text" name="congty" size="15" required></td>
      </tr>
      <tr>
        <td>Số điện thoại</td>
      ...
      <tr>
        <td>Địa chỉ</td>
        <td><input type="text" name="diachi" size="15" required></td>
      </tr>
      <tr>
        <td>Email</td>
