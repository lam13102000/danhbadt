...
<body>
  ...
  <div class="header">
    <h1>Website Quản Lý danh bạ điện thoại</h1>
  </div>

  <div class="topnav">
    <a href="homeadmin.php">Trang chủ</a>
    <a href="frmAddcongty.php">Thêm công ty</a>
    <a  href="homecongty.php">Kiểm tra công ty</a>
    <a href="dangxuat.php">Đăng Xuất</a>
  </div>
  <form action="searchcongty.php" method="POST">
  ...
  <br>
    <?php
      ...
      {  
			...
			$id=$_POST['key'];
        //Viết SQL => thực thi
        $sql_select="select * from congty where id like '%".$id."%'";
      ...
      if(mysqli_num_rows($kq)>0)
      {
        while($r=mysqli_fetch_array($kq))
        {
          echo "<tr>";
            ...
            echo "<td>".$r['diachi']."</td>";      
            echo "<td>".$r['email']."</td>";
            echo "<td> <a href='frmEditcongty.php?id=$id'>Sửa</a> </td>";
            echo "<td> <a href='deletect.php?id=$id'>Xóa</a> </td>";
          echo "</tr>";
        }
      }
